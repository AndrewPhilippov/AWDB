...
function outerFn(){
  ...
  return function innerFn(){
    // if we'll keep the chrome dev tools open
    // this will pouse our code and place us
...
function guessingGame(amount){
    ...
    return function(guess){
      if(!completed){
        ...
        if(guess === answer){
          completed = true;
          return 'You got it, the answer is '+ answer;
        } else if(guess > answer) return 'Your guess is too high';
          else if(guess < answer) return 'You guess is too low';
          else if(guesses === amount) 
            completed = true;
            return 'No more guesses left. The answer was '+answer;
      }
