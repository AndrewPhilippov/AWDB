...
hasEvenNumbers([1,2,3,4,5]);
hasEvenNumbers([1,3,5]);
...
// Check if every element in the array is array
...
function hasAZero(num){
  var newArr = num.toString();
  return newArr.split('').map(Number).some(num => {
    return num === 0;
  });
}
